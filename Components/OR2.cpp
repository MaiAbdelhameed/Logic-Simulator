...
void OR2::Label(string label) {
	m_Label = label;

}

ActionType OR2::SelectedComponentType()
{
	return ADD_OR_GATE_2;
}

void OR2::Save(ofstream& OutputFile, bool s)
{
	if (s == 1)
	{
		OutputFile << "OR2\t";
